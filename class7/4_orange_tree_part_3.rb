...
#added .fruit to test ;)
puts OrangeTree.new.fruit == OrangeTree.new(50).fruit
puts OrangeTree.new(20).fruit == OrangeTree.new(20).fruit
puts OrangeTree.new(20).fruit != OrangeTree.new(10).fruit
